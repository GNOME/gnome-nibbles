...
private class NibblesGame : Object
{
    ...
    /* Game models */
    public Gee.LinkedList<Worm> worms                       { internal get; private construct; default = new Gee.LinkedList<Worm> (); }
    public Boni boni                                        { internal get; private construct; default = new Boni (); }
    public WarpManager warp_manager                         { internal get; private construct; default = new WarpManager (); }
    public Gee.HashMap<Worm, WormProperties?> worm_props    { internal get; private construct; default = new Gee.HashMap<Worm, WormProperties?> (); }
